...
// WiFi credentials
const char *ssid = "Vy Hieu";            // Replace with your WiFi name
const char *password = "mocbaisau"; // Replace with your WiFi password

// MQTT Broker settings
const int mqtt_port = 8883;                                       // MQTT port (TLS)
const char *mqtt_broker = "u09672fa.ala.eu-central-1.emqxsl.com"; // EMQX broker endpoint
const char *mqtt_topic = "fallDetect";                            // MQTT topic
...
void mqttCallback(char *topic, byte *payload, unsigned int length)
{
  ...
  char message[length + 1]; // Thêm 1 để chứa ký tự kết thúc chuỗi '\0'
